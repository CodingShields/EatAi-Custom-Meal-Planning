	...
	return (
		<div className='comp-container-col'>
			...
			<div
				...
				className='height-container-metric-main'
			>
				<div className='height-btn-container'>
					<div className='height-btn-container-increment-selection'>
						<button
							style={{
					...
					<div className='height-btn-input-container-column'>
						<button className='height-btn-increment-top' onClick={handleIncrementMetric}>
							+
						</button>
						<input
						...
						<button
							...
							className='height-btn-decrement-bottom'
			...
			{/*  */}
			<div
				className='height-btn-container-imperial-main'
				style={{
					display: state.displayImperial ? "flex" : "none",
				}}
			>
				<div className='height-btn-container-imperial'>
					<button
						disabled={state.heightFeet === 10 ? true : false}
						className='height-btn-increment-left'
					...
					<button
						...
						className='height-btn-increment-right'
				...
				<div
					...
					className='height-input-container-imperial'
				>
					<input
				...
				>
					<button
						...
						className='height-btn-decrement-left'
					...
					<button
						...
						className='height-btn-decrement-right'
